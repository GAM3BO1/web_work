...
<body>
	<div class="container">
		...
		<table class="table table-striped">
			...
			<tbody class="table-groupe-divider">
			<%
				...
				for(GuestDto g: list){%>
					<tr>
						...
						<td><%=g.getRegdate() %></td>
						<td>
							<a href="updateform.jsp?num=<%=g.getNum() %>">
								<span class="visually-hidden">방명록 수정</span>
						...
						<td>
							<a href="deleteform.jsp?num=<%=g.getNum()%>">
								<span class="visually-hidden">방명록 삭제</span>
